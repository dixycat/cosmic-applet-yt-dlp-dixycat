...
mkdir -p ~/.local/bin/ ~/.local/lib/cosmic-applet-yt-dlp-dixycat/ ${XDG_DATA_HOME:-~/.local/share}/{applications,metainfo,icons/hicolor/scalable/apps}/
cp ./cosmic-applet-yt-dlp-dixycat ~/.local/bin/
cp ./deno ~/.local/lib/cosmic-applet-yt-dlp-dixycat/
